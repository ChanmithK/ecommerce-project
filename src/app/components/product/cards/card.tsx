...
const Card = ({ item }: ItemProps) => {
  ...
  return (
    ...
    >
      ...
      {/* product-card__image */}
      <div className=" relative block justify-center item">
        <Link href={`/pages/products/${item?.slug}`}>
          <Image
            ...
            width={800}
            height={800}
            className=" md:max-h-56 md:max-w-56"
          />
        </Link>
      </div>
      {/* product-card__info */}
      <div className="flex flex-col">
        ...
        <div className="flex pl-4">
          ...
          <Link
            className="text-md font-medium  md:min-h-12"
        ...
        <div className="flex flex-col w-full">
          ...
          <div className="flex justify-between">
            ...
            <button
              ...
              className={`relative border-0 rounded-full p-3  ${
