...
import { Products, variant } from "../../../../type";
...
const ProductCardModal = () => {
  ...
  const { data, isModalOpen } = useSelector(selectModalData);

  const item: Products | undefined =
  ...
  const handleColorSelect = (color: string | null) => {
    ...
    // setSelectedSize(Array.from(uniqueSizeNames)[0] ?? null);
  };
      ...
      ${
        uniqueColorNames.every(
          ...
          : ""
                ...
                onClick={() => {
                  console.log("Color Selected:", colorData.colorName);
                  handleColorSelect(colorData.colorName);
                }}
              ></button>
            );
          })}
    ...
    return (
      <div className="col-span-3">
        ...
        <div className="mt-2 flex items-center">
          ...
          <h4 className="text-xs text-gray-600 ml-2">
            {item?.reviews} reviews
          </h4>
        </div>
        <div className="grid grid-cols-4 mobile:grid-cols-2 gap-1 mt-3">
    ...
    <div>
      {isModalOpen && (
        <div
          ...
          tabIndex={-1}
          aria-hidden="true"
          className="fixed inset-0 z-50 overflow-auto bg-black bg-opacity-50 flex justify-center lg:items-center  "
        >
          <div>
            <div className="bg-white  p-8 rounded-xl grid grid-flow-row overflow-y-auto mobile:max-h-screen">
              <div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 max-w-screen-lg w-full">
                      ...
                      <div className="col-span-3">
                        <div className="mt-4 flex items-center">
                          ...
                          <button
                            ...
                            className={`ml-4  text-white px-4 py-2 bg-primary rounded-lg ${
                              addtoCartDisable
                                ? "opacity-25"
                                : " hover:bg-secondary"
                            }`}
              ...
              <div className="border-t-2 mt-5">
                <h4 className="flex justify-center mt-4 text-gray-500 text-lg pointer-events-auto">
                  See full details
                </h4>{" "}
              </div>
            </div>
